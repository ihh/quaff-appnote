...
\abstract{
  ...
  Quaff is an open source command-line tool for aligning long FASTQ-format reads to a FASTA reference genome using a conditional pair HMM (transducer) that models context-dependent sequencing errors and quality scores.
